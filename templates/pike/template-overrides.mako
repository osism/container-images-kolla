...
{% set elasticsearch_packages_append = ['elasticsearch-curator'] %}

{% set horizon_packages_append = ['locales', 'tzdata'] %}

{% set rabbitmq_packages_remove = ['http://www.rabbitmq.com/releases/rabbitmq-server/v3.6.5/rabbitmq-server_3.6.5-1_all.deb'] %}
...
% for project in ("openstack", "openvswitch", "redis", "aodh", "ceilometer", "cinder", "glance", "gnocchi", "heat", "keystone", "magnum", "manila", "mistral", "neutron", "nova", "panko", "searchlight"):
