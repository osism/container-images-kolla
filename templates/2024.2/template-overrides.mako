...
RUN apt-get update ${"\\"}
    ...
    && apt-get clean ${"\\"}
    && rm -rf /var/lib/apt/lists/* ${"\\"}
    && curl -o /tmp/liboauth2.deb "https://github.com/OpenIDC/liboauth2/releases/download/v1.6.3/liboauth2_1.6.3-1.noble_amd64.deb" ${"\\"}
    && dpkg -i /tmp/liboauth2.deb ${"\\"}
    && rm -f /tmp/liboauth2.deb ${"\\"}
    && curl -o /tmp/liboauth2-apache.deb "https://github.com/OpenIDC/liboauth2/releases/download/v1.6.3/liboauth2-apache_1.6.3-1.noble_amd64.deb" ${"\\"}
    && dpkg -i /tmp/liboauth2-apache.deb ${"\\"}
    && rm -f /tmp/liboauth2-apache.deb ${"\\"}
    && curl -o /tmp/libapache2-mod-oauth2.deb "https://github.com/OpenIDC/mod_oauth2/releases/download/v3.4.0/libapache2-mod-oauth2_3.4.0-1.noble_amd64.deb" ${"\\"}
